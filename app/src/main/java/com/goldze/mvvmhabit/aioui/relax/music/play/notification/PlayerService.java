...
package com.goldze.mvvmhabit.aioui.relax.music.play.notification;
...
import com.goldze.mvvmhabit.aioui.relax.music.play.Configs;
...
import com.goldze.mvvmhabit.utils.ImageUtils;
...
public class PlayerService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        AIOAlbum.AIOMusic results = PlayerManager.getInstance().getCurrentPlayingMusic();
        if (results == null) {
            stopSelf();
    ...
    private void createNotification(AIOAlbum.AIOMusic testMusic) {
        try {
            String title = testMusic.getTitle();
            AIOAlbum album = PlayerManager.getInstance().getAlbum();
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                NotificationChannelGroup playGroup = new NotificationChannelGroup(GROUP_ID, "播放");
