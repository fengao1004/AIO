...
import static com.goldze.mvvmhabit.aioui.webview.WebViewActivity.MODE_SONIC;
...
public class AIORecyclerViewItemViewModel extends ItemViewModel<AIOViewPagerItemViewModel> {
    ...
    public AIORecyclerViewItemViewModel(@NonNull AIOViewPagerItemViewModel viewModel, DemoEntity.ItemsEntity entity) {
        super(viewModel);
